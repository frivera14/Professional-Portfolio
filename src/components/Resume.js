    ...
    return (
        <>
            <div className="container mt-3 fs-5">
               <a className="text-dark" href={require('../assets/Francisco_Rivera22.docx')} download> <p>Find my resume here <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-file-earmark-arrow-down" viewBox="0 0 16 16">
